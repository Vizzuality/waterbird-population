...
const speciesPopulationInfo = [
    ...
    description: (
      <div>
        ...
        <p>
          ...
          been identified with the suffix (bre); those identified primarily on the basis of their
  ...
  },
  {
    ...
    description: (
      <div>
        <p>
          Two columns define the main breeding range and core non-breeding (‘wintering’ or
          ‘contranuptial’) range of every recognised population of a species or subspecies. Many
          migratory species, especially the long-distance migrants, sometimes stray far outside
          their normal ranges. The occurrence of these vagrants has not been taken into account in
          the range descriptions, which are intended to indicate where the great bulk of the
          population occurs during its normal annual cycle. In the case of sedentary species, a
          single entry in the Breeding range column describes the overall range of the population
          concerned.
        </p>
        <p>
          It will be noticed that in many cases there is considerable similarity between the
          breeding ranges or non-breeding ranges of two or more populations of the same species. In
          some cases, this is because of a genuine overlap in the distribution of the populations.
          Thus, many populations defined on the basis of their breeding ranges are known to mix
          extensively with other populations of the same species in their non-breeding (‘wintering’)
          range, while many populations defined on the basis of their non-breeding ranges are known
          to overlap extensively with other populations on their breeding grounds. In many other
          cases, however, the main reason for an apparent similarity in ranges during the
          non-breeding season is uncertainty as to the limits of the non-breeding range of a
          particular population within the non-breeding range of the species or subspecies as a
          whole. In these cases, the non-breeding range is given only in very general terms, and
          will need refining as further information becomes available.
        </p>
        <p>
          The larger geographical regions most commonly used to describe the ranges of populations
          in the range description columns are listed below alongside the range states that they
          usually encompass. This list does not attempt to conform to any other definitions of these
          regions, and the groupings of states have been defined with no purpose other than to
          describe the boundaries of waterbird populations. Furthermore, these groupings are
          intended only as a guideline to the countries in which the population in question may
          occur. Depending on the species concerned, a minority of countries might be excluded from
          each region, or one or more additional countries might be added. In many cases, the
