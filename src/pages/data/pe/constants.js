const estimatesInfo = [
  ...
  },
  {
    ...
    list: [
      { itemNumbered: '<span>No estimate: </span> No population estimate is available;' },
      { itemNumbered: '<span>Best guess: </span> Population estimate is only possible with large or uncertain ranges;' },
