...
const FSInfo = [
  {
    description: (
      <div className="l-fs-card">
        ...
        <ul>
          <li>Aarhus Universtiy, Department of Bioscience, Denmark</li>
          <li>African-Eurasian Migratory Waterbird Agreement (AEWA)</li>
          <li>Alterra Green World Research, The Netherlands</li>
          <li>Department for Environment, Food & Rural Affairs, United Kingdom</li>
          <li>Department for Fisheries & Game, Ministry of Agriculture & Forestry, Finland</li>
          <li>Environmental Protection Agency, Sweden</li>
          <li>Federal Office for the Environment, Switzerland</li>
          <li>Forest & Nature Agency, Ministry of the Environment, Denmark</li>
          <li>Lynx Edicions, Spain</li>
          <li>Migratory Birds of the Western Palearctic (OMPO), France</li>
          <li>Ministry of Economic Affairs, Agriculture and Innovation, The Netherlands</li>
          <li>Nature & Forest Division, Ministry of Wallonia, Belgium</li>
          <li>Office National de la Chasse et de la Faune Sauvage (ONCFS), France</li>
          <li>The Heritage Service, Ireland</li>
          <li>The Joint Nature Conservation Committee (JNCC), United Kingdom</li>
          <li>The Wildfowl and Wetlands Trust, United Kingdom</li>
        </ul>
