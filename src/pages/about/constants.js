...
const AboutInfo = [
  {
    ...
    description: (
      <div>
        <p>
          No, the information on the WPE website is open access and freely available to all parties.
          Registration is only required for a limited number of invited persons acting as
          coordinators or editors for a region or taxonomic group. For general users, registration
          will provide no additional benefits.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    description: (
      <div>
        <p>
          Earlier editions of the WPE are now out of print. All editions of WPE are now only
          available through this website. You can export information from this site to a pdf by
          using the print options in the bottom left corner of the search results and population
          detail screens.
        </p>
      </div>
    ),
    ...
    description: (
      <div>
        <ol type="i">
          ...
          <li>
            The species search field recognises partial string searches for both the BTWG recognised
            common (English) and scientific name. Try searching for the genus or a part of the
            species name e.g. “Scoter” or “Larus”.
          </li>
          <li>
    ...
    description: (
      <div>
        <p>
          ...
          and efficiency of downloads for all users.
        </p>
      </div>
    ),
  },
