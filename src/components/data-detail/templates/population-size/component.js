...
const PopulationSize = ({ data, user }) => {
  ...
  return (
    <div className={classnames('c-population-size', { '-collapse': isCollapsed })}>
          ...
          {data.map((d) => (
            ...
            >
              ...
              >
                ...
                <td>
                  <span className="cell-content">{d.minimum}</span>
                </td>
                <td>
                  <span className="cell-content">{d.maximum}</span>
                </td>
                <td>
